        ...
        <div class="what-we-do we-padding">
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-tittle text-center"><h2>CARTELERA</h2></div>
                ...
                <div class="section-tittle text-center" ><?php if((isset($nombre))){ ?><h3>Genero seleccionado: <?=$nombre?></h3> <?php } ?></div>            
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-do text-center mb-30">
                                <form action="<?php echo FRONT_ROOT?>Home/Comprar" method="POST">
                                    <img class="col-lg-10 col-md-6"  src="<?php echo IMAGE_ROOT . $values->getPosterHorizontal();?>"  style="width:500px; weight:300px; position:relative;" />
                                    ...
                                    <div class="do-btn" style="padding: 10px;"><button type="submit"class='btn btn-primary'>Comprar entrada</button></div>
                                </form>
                            </div>
                        </div>
                    <?php } ?>
