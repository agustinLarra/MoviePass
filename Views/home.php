...
<body>
	<div class="wrapper">
		...
		<header class="header">
			<figure class="logo"><a href="home.php"><img src="img/logo.png" alt="Logo"></figure></a>
			<nav class="menu">
				<ul>
		...
		<main class="content">
			<section class="panel">
				...
				<div class="recentslider">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide"><a href="single.html"><img src=<?php echo IMAGE_ROOT . $value->getPoster();?>><h3 class="hometitle"><?php echo $value->getTitle();?></h3></a></div>
